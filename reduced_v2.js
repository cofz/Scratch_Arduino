/*
 *Reduced version of the Arduino Experimental Extension for Scratch by Kreg Hanning and David Mellis
 *
...
(function(ext) {
  ...
  var blocks = {
    ...
    //  ['-'],
      [' ', 'set digital output %n %m.outputs', 'digitalWrite', 13, 'on'],
      [' ', 'set analog output %n to %n%', 'analogWrite', 5, 100],
      ['-'],
      ['h', 'when digital input %n is %m.outputs', 'whenDigitalRead', 3, 'on'],
      ['b', 'digital input %n on?', 'digitalRead', 1],
      ['-'],
      ['h', 'when analog input %n %m.ops %n%', 'whenAnalogRead', 0, '>', 50],
      ['r', 'read analog input %n', 'analogRead', 0],
      ['-'],
